...
class MedWalletCard extends StatefulWidget {
  ...
  final String nextMedicationDosage;
  ...
  const MedWalletCard({
    ...
    required this.nextMedicationDosage,
      ...
      child: widget.isWelcomeMode
          ? Column(
              ...
              children: [
                ...
                Text(
                  widget.nextMedicationName, // Title: Welcome to QuickMed!
                ...
                Text(
                  widget.nextDoseTime, // Subtitle: Welcome message
                  style: TextStyle(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _revealed
                                ? (widget.nextMedicationDosage.isNotEmpty
                                    ? "${widget.nextMedicationName} (${widget.nextMedicationDosage}) · ${widget.nextDoseTime}"
